...
custom_creep_scaling          = custom_creep_scaling or class({})
modifier_custom_creep_scaling = modifier_custom_creep_scaling or class({})
...
function modifier_custom_creep_scaling:IsPurgable() return false end
