...
imba_grimstroke_dark_artistry                             = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_grimstroke_dark_artistry_extend             = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_grimstroke_dark_artistry_slow               = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_grimstroke_dark_artistry_ink_line           = class(VANILLA_ABILITIES_BASECLASS)

imba_grimstroke_ink_creature                              = class(VANILLA_ABILITIES_BASECLASS)
-- This applies on the phantom and handles the phantom's particles/animations and how it takes damage
modifier_imba_grimstroke_ink_creature_thinker             = class(VANILLA_ABILITIES_BASECLASS)
-- This applies on the enemy and provides vision
modifier_imba_grimstroke_ink_creature_vision              = class(VANILLA_ABILITIES_BASECLASS)
-- This applies on the enemy and handles the silence/mute
modifier_imba_grimstroke_ink_creature                     = class(VANILLA_ABILITIES_BASECLASS)
-- This applies on the enemy and counts "modifier_imba_grimstroke_ink_creature" modifiers and handles damage instances
modifier_imba_grimstroke_ink_creature_debuff              = class(VANILLA_ABILITIES_BASECLASS)

imba_grimstroke_spirit_walk                               = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_grimstroke_spirit_walk_buff                 = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_grimstroke_spirit_walk_debuff               = class(VANILLA_ABILITIES_BASECLASS)

imba_grimstroke_ink_gods_incarnation                      = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_grimstroke_ink_gods_incarnation             = class(VANILLA_ABILITIES_BASECLASS)

-- imba_grimstroke_soul_chain						= class(VANILLA_ABILITIES_BASECLASS)
-- modifier_imba_grimstroke_soul_chain				= class(VANILLA_ABILITIES_BASECLASS)

-- This modifies the vanilla Soulbind, until (if ever) a truly correct custom Soulbind is implemented
imba_grimstroke_soul_chain_vanilla_enhancer               = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_grimstroke_soul_chain_vanilla_enhancer      = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_grimstroke_soul_chain_vanilla_enhancer_slow = class(VANILLA_ABILITIES_BASECLASS)
...
function imba_grimstroke_dark_artistry:GetCooldown(level)
	if self:GetCaster():HasModifier("modifier_imba_grimstroke_dark_artistry_ink_line") then
		return self:GetRightfulKV("AbilityCooldown") + self:GetSpecialValueFor("ink_lines_cd_increase")
	else
...
modifier_special_bonus_imba_grimstroke_ink_swell_max_damage = modifier_special_bonus_imba_grimstroke_ink_swell_max_damage or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_grimstroke_phantoms_embrace_extra_hits = modifier_special_bonus_imba_grimstroke_phantoms_embrace_extra_hits or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_grimstroke_ink_swell_radius = modifier_special_bonus_imba_grimstroke_ink_swell_radius or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_grimstroke_stroke_of_fate_damage = modifier_special_bonus_imba_grimstroke_stroke_of_fate_damage or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_grimstroke_stroke_of_fate_cast_range = class(VANILLA_ABILITIES_BASECLASS)
