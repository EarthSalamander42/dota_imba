...
imba_arc_warden_flux                                         = imba_arc_warden_flux or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_arc_warden_flux                                = modifier_imba_arc_warden_flux or class(VANILLA_ABILITIES_BASECLASS)

imba_arc_warden_magnetic_field                               = imba_arc_warden_magnetic_field or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_arc_warden_magnetic_field_thinker_attack_speed = modifier_imba_arc_warden_magnetic_field_thinker_attack_speed or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_arc_warden_magnetic_field_thinker_evasion      = modifier_imba_arc_warden_magnetic_field_thinker_evasion or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_arc_warden_magnetic_field_attack_speed         = modifier_imba_arc_warden_magnetic_field_attack_speed or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_arc_warden_magnetic_field_evasion              = modifier_imba_arc_warden_magnetic_field_evasion or class(VANILLA_ABILITIES_BASECLASS)

imba_arc_warden_spark_wraith                                 = imba_arc_warden_spark_wraith or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_arc_warden_spark_wraith_thinker                = modifier_imba_arc_warden_spark_wraith_thinker or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_arc_warden_spark_wraith_purge                  = modifier_imba_arc_warden_spark_wraith_purge or class(VANILLA_ABILITIES_BASECLASS)
...
function imba_arc_warden_spark_wraith:GetCooldown(level)
	return self:GetRightfulKV("AbilityCooldown") - self:GetCaster():FindTalentValue("special_bonus_imba_arc_warden_spark_wraith_cooldown")
end
...
modifier_special_bonus_imba_arc_warden_flux_cast_range       = modifier_special_bonus_imba_arc_warden_flux_cast_range or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_arc_warden_spark_wraith_cooldown = modifier_special_bonus_imba_arc_warden_spark_wraith_cooldown or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_arc_warden_spark_wraith_damage   = modifier_special_bonus_imba_arc_warden_spark_wraith_damage or class(VANILLA_ABILITIES_BASECLASS)
