...
---------------------------------------
imba_beastmaster_summon_hawk = imba_beastmaster_summon_hawk or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_beastmaster_hawk = modifier_imba_beastmaster_hawk or class(VANILLA_ABILITIES_BASECLASS)
...
function modifier_imba_beastmaster_hawk:GetModifierMoveSpeed_Absolute()
	return 1200
end
...
-----------------------------------------------------
imba_beastmaster_hawk_invis = imba_beastmaster_hawk_invis or class(VANILLA_ABILITIES_BASECLASS)
...
--- Hawk invis checker
----------------------
modifier_imba_hawk_invis_handler = modifier_imba_hawk_invis_handler or class(VANILLA_ABILITIES_BASECLASS)
...
--- Hawk invis
---------------
modifier_imba_hawk_invis = modifier_imba_hawk_invis or class(VANILLA_ABILITIES_BASECLASS)
...
imba_beastmaster_summon_boar = imba_beastmaster_summon_boar or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_beastmaster_boar = modifier_imba_beastmaster_boar or class(VANILLA_ABILITIES_BASECLASS)
...
imba_beastmaster_boar_poison = imba_beastmaster_boar_poison or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_boar_poison = modifier_imba_boar_poison or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_boar_poison_debuff = modifier_imba_boar_poison_debuff or class(VANILLA_ABILITIES_BASECLASS)
