...
imba_gyrocopter_rocket_barrage                                = imba_gyrocopter_rocket_barrage or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_rocket_barrage                       = modifier_imba_gyrocopter_rocket_barrage or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_rocket_barrage_ballistic_suppression = modifier_imba_gyrocopter_rocket_barrage_ballistic_suppression or class(VANILLA_ABILITIES_BASECLASS)

imba_gyrocopter_homing_missile                                = imba_gyrocopter_homing_missile or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_homing_missile_handler               = modifier_imba_gyrocopter_homing_missile_handler or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_homing_missile_pre_flight            = modifier_imba_gyrocopter_homing_missile_pre_flight or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_homing_missile                       = modifier_imba_gyrocopter_homing_missile or class(VANILLA_ABILITIES_BASECLASS)

modifier_imba_gyrocopter_lock_on                              = modifier_imba_gyrocopter_lock_on or class(VANILLA_ABILITIES_BASECLASS)

imba_gyrocopter_flak_cannon                                   = imba_gyrocopter_flak_cannon or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_flak_cannon                          = modifier_imba_gyrocopter_flak_cannon or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_flak_cannon_speed_handler            = modifier_imba_gyrocopter_flak_cannon_speed_handler or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_flak_cannon_side_gunner              = modifier_imba_gyrocopter_flak_cannon_side_gunner or class(VANILLA_ABILITIES_BASECLASS)

imba_gyrocopter_gatling_guns                                  = imba_gyrocopter_gatling_guns or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_gatling_guns_handler                 = modifier_imba_gyrocopter_gatling_guns_handler or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_gatling_guns_wind_up                 = modifier_imba_gyrocopter_gatling_guns_wind_up or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_gatling_guns                         = modifier_imba_gyrocopter_gatling_guns or class(VANILLA_ABILITIES_BASECLASS)

imba_gyrocopter_call_down                                     = imba_gyrocopter_call_down or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_call_down_thinker                    = modifier_imba_gyrocopter_call_down_thinker or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_gyrocopter_call_down_slow                       = modifier_imba_gyrocopter_call_down_slow or class(VANILLA_ABILITIES_BASECLASS)
...
function modifier_imba_gyrocopter_lock_on:CheckState()
	if IsServer() and not self:GetCaster():CanEntityBeSeenByMyTeam(self:GetParent()) then
		self:Destroy()
		return
	end
...
function imba_gyrocopter_gatling_guns:OnOwnerSpawned()
	...
	if caster:HasModifier("modifier_imba_gyrocopter_gatling_guns_handler") then
		caster:FindModifierByName("modifier_imba_gyrocopter_gatling_guns_handler"):StartIntervalThink(1)
	end

	if caster:HasTalent("special_bonus_imba_gyrocopter_gatling_guns_activate") and not caster:HasModifier("modifier_special_bonus_imba_gyrocopter_gatling_guns_activate") then
		caster:AddNewModifier(caster, caster:FindAbilityByName("special_bonus_imba_gyrocopter_gatling_guns_activate"), "modifier_special_bonus_imba_gyrocopter_gatling_guns_activate", {})
	end
end
...
function modifier_imba_gyrocopter_gatling_guns:OnIntervalThink()
	if not self.ammo_modifier or self.ammo_modifier:IsNull() then
		self:StartIntervalThink(-1)
		return
	end
...
function imba_gyrocopter_call_down:GetCooldown(level)
	return self:GetRightfulKV("AbilityCooldown") - self:GetCaster():FindTalentValue("special_bonus_imba_gyrocopter_call_down_cooldown")
end
...
modifier_special_bonus_imba_gyrocopter_flak_cannon_attacks   = modifier_special_bonus_imba_gyrocopter_flak_cannon_attacks or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_gyrocopter_rocket_barrage_damage = modifier_special_bonus_imba_gyrocopter_rocket_barrage_damage or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_gyrocopter_call_down_cooldown     = modifier_special_bonus_imba_gyrocopter_call_down_cooldown or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_gyrocopter_gatling_guns_activate  = modifier_special_bonus_imba_gyrocopter_gatling_guns_activate or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_gyrocopter_homing_missile_charges = modifier_special_bonus_imba_gyrocopter_homing_missile_charges or class(VANILLA_ABILITIES_BASECLASS)
