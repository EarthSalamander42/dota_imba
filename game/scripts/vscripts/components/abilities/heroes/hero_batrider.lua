...
imba_batrider_sticky_napalm                      = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_batrider_sticky_napalm_handler     = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_batrider_sticky_napalm             = class(VANILLA_ABILITIES_BASECLASS)

imba_batrider_flamebreak                         = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_batrider_flamebreak_damage         = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_batrider_flamebreak_damage_thinker = class(VANILLA_ABILITIES_BASECLASS)

imba_batrider_firefly                            = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_batrider_firefly                   = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_batrider_firefly_thinker           = class(VANILLA_ABILITIES_BASECLASS)

imba_batrider_methane_boost                      = class(VANILLA_ABILITIES_BASECLASS)

imba_batrider_flaming_lasso                      = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_batrider_flaming_lasso             = class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_batrider_flaming_lasso_self        = class(VANILLA_ABILITIES_BASECLASS)
...
function imba_batrider_flamebreak:GetCooldown(level)
	return self:GetRightfulKV("AbilityCooldown") - self:GetCaster():FindTalentValue("special_bonus_unique_imba_batrider_flamebreak_cooldown")
end
...
function modifier_imba_batrider_firefly_thinker:CheckState()
	return {
...
modifier_special_bonus_unique_imba_batrider_flamebreak_cooldown = class(VANILLA_ABILITIES_BASECLASS)
