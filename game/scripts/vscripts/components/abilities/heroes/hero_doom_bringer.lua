...
imba_doom_bringer_doom = class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_doom_bringer_doom = class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_doom_bringer_doom_handler = class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_doom_bringer_doom_enemies = class(VANILLA_ABILITIES_BASECLASS)
