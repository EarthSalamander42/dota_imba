...
modifier_special_bonus_imba_lina_8 = modifier_special_bonus_imba_lina_8 or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_blazing_fire = class(VANILLA_ABILITIES_BASECLASS)
...
imba_lina_dragon_slave = class(VANILLA_ABILITIES_BASECLASS)

function imba_lina_dragon_slave:GetCooldown(level)
	return self:GetRightfulKV("AbilityCooldown") - self:GetCaster():FindTalentValue("special_bonus_imba_lina_10")
end
...
imba_lina_light_strike_array = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_lsa_talent_magma = modifier_imba_lsa_talent_magma or class(VANILLA_ABILITIES_BASECLASS)
...
imba_lina_light_strike_array_v2                         = imba_lina_light_strike_array_v2 or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_lina_light_strike_array_v2_thinker        = modifier_imba_lina_light_strike_array_v2_thinker or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_lina_light_strike_array_v2_thinker_single = modifier_imba_lina_light_strike_array_v2_thinker_single or class(VANILLA_ABILITIES_BASECLASS)
...
imba_lina_fiery_soul = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_fiery_soul = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_fiery_soul_talent = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_fiery_soul_counter = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_lina_3 = modifier_special_bonus_imba_lina_3 or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_fiery_soul_blaze_burn = class(VANILLA_ABILITIES_BASECLASS)
...
imba_lina_laguna_blade = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_lina_6 = modifier_special_bonus_imba_lina_6 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_lina_7 = modifier_special_bonus_imba_lina_7 or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_lina_9 = class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_lina_10 = class(VANILLA_ABILITIES_BASECLASS)
