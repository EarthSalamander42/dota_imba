...
function modifier_imba_mars_spear_trailblazer_thinker:CheckState()
	return {
...
function modifier_imba_mars_bulwark_active:DeclareFunctions()
	return {
...
function modifier_imba_mars_arena_of_blood_coliseum:DeclareFunctions()
	return {
...
function modifier_imba_mars_arena_of_blood_coliseum:AddCustomTransmitterData()
	return {
