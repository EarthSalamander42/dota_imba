...
imba_rubick_spell_steal_controller = imba_rubick_spell_steal_controller or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_rubick_spell_steal_controller = modifier_imba_rubick_spell_steal_controller or class(VANILLA_ABILITIES_BASECLASS)
