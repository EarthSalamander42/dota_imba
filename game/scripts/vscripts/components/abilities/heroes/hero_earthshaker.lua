...
imba_earthshaker_fissure                     = imba_earthshaker_fissure or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_earthshaker_fissure_thinker    = modifier_imba_earthshaker_fissure_thinker or class(VANILLA_ABILITIES_BASECLASS)

imba_earthshaker_enchant_totem               = imba_earthshaker_enchant_totem or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_earthshaker_enchant_totem      = modifier_imba_earthshaker_enchant_totem or class(VANILLA_ABILITIES_BASECLASS)
modifier_imba_earthshaker_enchant_totem_leap = modifier_imba_earthshaker_enchant_totem_leap or class(VANILLA_ABILITIES_BASECLASS)
...
earthshaker_fissure_lua = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_earthshaker_fissure_lua_thinker = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_earthshaker_fissure_lua_prevent_movement = class(VANILLA_ABILITIES_BASECLASS)
...
earthshaker_enchant_totem_lua = class(VANILLA_ABILITIES_BASECLASS)
...
function earthshaker_enchant_totem_lua:GetCooldown(nLevel)
	return self:GetRightfulKV("AbilityCooldown") - self:GetCaster():FindTalentValue("special_bonus_unique_earthshaker")
end
...
modifier_earthshaker_enchant_totem_lua = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_earthshaker_enchant_totem_lua_movement = modifier_earthshaker_enchant_totem_lua_movement or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_earthshaker_enchant_totem_lua_leap = class(VANILLA_ABILITIES_BASECLASS)
...
earthshaker_aftershock_lua = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_earthshaker_aftershock_lua = class(VANILLA_ABILITIES_BASECLASS)
...
imba_earthshaker_echo_slam = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_unique_earthshaker                      = class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_earthshaker_bonus_magic_resistance = modifier_special_bonus_imba_earthshaker_bonus_magic_resistance or class(VANILLA_ABILITIES_BASECLASS)
