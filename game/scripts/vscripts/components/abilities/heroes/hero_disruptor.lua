...
imba_disruptor_stormbearer = imba_disruptor_stormbearer or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_stormbearer = modifier_imba_stormbearer or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_thunder_strike_slow = modifier_imba_thunder_strike_slow or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_thunder_strike_talent_slow = modifier_imba_thunder_strike_talent_slow or class(VANILLA_ABILITIES_BASECLASS)
...
imba_disruptor_glimpse = imba_disruptor_glimpse or class(VANILLA_ABILITIES_BASECLASS)
...
--	Glimpse Thinker
-------------------------------------------
modifier_imba_glimpse_thinker = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_glimpse_talent_indicator = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_glimpse_movement_check_aura = modifier_imba_glimpse_movement_check_aura or class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_glimpse = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_glimpse_storm_aura = modifier_imba_glimpse_storm_aura or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_glimpse_storm_debuff = modifier_imba_glimpse_storm_debuff or class(VANILLA_ABILITIES_BASECLASS)
...
imba_disruptor_kinetic_field = imba_disruptor_kinetic_field or class(VANILLA_ABILITIES_BASECLASS)
...
---------------------------------------------------
modifier_imba_kinetic_field = modifier_imba_kinetic_field or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_kinetic_field_aura_modifier = modifier_imba_kinetic_field_aura_modifier or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_kinetic_field_check_inside_field = modifier_imba_kinetic_field_check_inside_field or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_kinetic_field_check_position = modifier_imba_kinetic_field_check_position or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_kinetic_field_barrier = modifier_imba_kinetic_field_barrier or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_kinetic_field_knockback = modifier_imba_kinetic_field_knockback or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_kinetic_field_pull = modifier_imba_kinetic_field_pull or class(VANILLA_ABILITIES_BASECLASS)
...
---------------------------------------------------
modifier_imba_static_storm = modifier_imba_static_storm or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_static_storm_debuff_aura = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_static_storm_talent = modifier_imba_static_storm_talent or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_static_storm_talent_ministun = modifier_imba_static_storm_talent_ministun or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_static_storm_talent_ministun_trigger = modifier_imba_static_storm_talent_ministun_trigger or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_disruptor_1 = modifier_special_bonus_imba_disruptor_1 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_disruptor_3 = modifier_special_bonus_imba_disruptor_3 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_disruptor_8 = modifier_special_bonus_imba_disruptor_8 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_disruptor_10 = modifier_special_bonus_imba_disruptor_10 or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_disruptor_9 = class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_disruptor_kinetic_field_true_sight = modifier_special_bonus_imba_disruptor_kinetic_field_true_sight or class(VANILLA_ABILITIES_BASECLASS)
