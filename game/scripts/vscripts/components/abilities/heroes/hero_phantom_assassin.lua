...
imba_phantom_assassin_stifling_dagger = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_stifling_dagger_slow = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_stifling_dagger_silence = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_stifling_dagger_bonus_damage = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_stifling_dagger_dmg_reduction = class(VANILLA_ABILITIES_BASECLASS)
...
imba_phantom_assassin_phantom_strike = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_phantom_strike = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_phantom_strike_coup_de_grace = class(VANILLA_ABILITIES_BASECLASS)
...
imba_phantom_assassin_blur = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_blur = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_blur_speed = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_blur_blur = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_blur_smoke = class(VANILLA_ABILITIES_BASECLASS)
...
imba_phantom_assassin_coup_de_grace = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_coup_de_grace = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_coup_de_grace_crit = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_phantom_assassin_10 = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_phantom_assassin_gravestone = modifier_phantom_assassin_gravestone or class(VANILLA_ABILITIES_BASECLASS)

function modifier_phantom_assassin_gravestone:IsHidden() return true end

function modifier_phantom_assassin_gravestone:CheckState()
	return {
...
modifier_phantom_assassin_arcana = modifier_phantom_assassin_arcana or class(VANILLA_ABILITIES_BASECLASS)
...
function modifier_phantom_assassin_arcana:DeclareFunctions()
	return {
		MODIFIER_EVENT_ON_HERO_KILLED,
	}
end
...
modifier_special_bonus_imba_phantom_assassin_9 = modifier_special_bonus_imba_phantom_assassin_9 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_phantom_assassin_3 = modifier_special_bonus_imba_phantom_assassin_3 or class(VANILLA_ABILITIES_BASECLASS)
