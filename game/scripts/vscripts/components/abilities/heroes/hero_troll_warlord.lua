...
imba_troll_warlord_berserkers_rage = imba_troll_warlord_berserkers_rage or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_berserkers_rage_ensnare = class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_berserkers_rage_melee = modifier_imba_berserkers_rage_melee or class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_berserkers_rage_ranged = modifier_imba_berserkers_rage_ranged or class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_berserkers_rage_slow = modifier_imba_berserkers_rage_slow or class(VANILLA_ABILITIES_BASECLASS)
...
imba_troll_warlord_whirling_axes_ranged = imba_troll_warlord_whirling_axes_ranged or class(VANILLA_ABILITIES_BASECLASS)
...
function imba_troll_warlord_whirling_axes_ranged:GetCooldown(nLevel)
	return self:GetRightfulKV("AbilityCooldown") - self:GetCaster():FindTalentValue("special_bonus_imba_troll_warlord_5")
end
...
-------------------------------------------
modifier_imba_whirling_axes_ranged = modifier_imba_whirling_axes_ranged or class(VANILLA_ABILITIES_BASECLASS)
...
imba_troll_warlord_whirling_axes_melee = imba_troll_warlord_whirling_axes_melee or class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_whirling_axes_melee = modifier_imba_whirling_axes_melee or class(VANILLA_ABILITIES_BASECLASS)
...
imba_troll_warlord_fervor = imba_troll_warlord_fervor or class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_fervor = modifier_imba_fervor or class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_fervor_stacks = modifier_imba_fervor_stacks or class(VANILLA_ABILITIES_BASECLASS)
...
imba_troll_warlord_battle_trance = imba_troll_warlord_battle_trance or class(VANILLA_ABILITIES_BASECLASS)
...
-------------------------------------------
modifier_imba_battle_trance = modifier_imba_battle_trance or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_battle_trance_720 = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_imba_battle_trance_vision_720 = class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_troll_warlord_7 = modifier_special_bonus_imba_troll_warlord_7 or class(VANILLA_ABILITIES_BASECLASS)
...
modifier_special_bonus_imba_troll_warlord_1                     = modifier_special_bonus_imba_troll_warlord_1 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_troll_warlord_2                     = modifier_special_bonus_imba_troll_warlord_2 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_troll_warlord_4                     = modifier_special_bonus_imba_troll_warlord_4 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_troll_warlord_5                     = modifier_special_bonus_imba_troll_warlord_5 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_troll_warlord_8                     = modifier_special_bonus_imba_troll_warlord_8 or class(VANILLA_ABILITIES_BASECLASS)
modifier_special_bonus_imba_troll_warlord_battle_trance_upgrade = modifier_special_bonus_imba_troll_warlord_battle_trance_upgrade or class(VANILLA_ABILITIES_BASECLASS)
