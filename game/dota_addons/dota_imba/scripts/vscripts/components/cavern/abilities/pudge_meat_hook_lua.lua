...
LinkLuaModifier( "modifier_pudge_meat_hook_followthrough_lua", "components/cavern/modifiers/modifier_pudge_meat_hook_followthrough_lua",  LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier(  "modifier_pudge_meat_hook_lua", "components/cavern/modifiers/modifier_pudge_meat_hook_lua", LUA_MODIFIER_MOTION_HORIZONTAL )
