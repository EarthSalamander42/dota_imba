...
LinkLuaModifier( "modifier_creature_wraith_king_reincarnation", "components/cavern/modifiers/modifier_creature_wraith_king_reincarnation", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_creature_wraith_king_wake", "components/cavern/modifiers/modifier_creature_wraith_king_wake", LUA_MODIFIER_MOTION_NONE )
--------------------------------------------------------------------
