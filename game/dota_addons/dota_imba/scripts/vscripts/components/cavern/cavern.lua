...
require( "components/cavern/constants" ) -- require constants first
require( "components/cavern/utility_functions" ) -- require utility_functions early (other required files may use its functions)
require( "components/cavern/cavern_utility_functions" ) 
require( "components/cavern/precache" )
require( "components/cavern/events" )
require( "components/cavern/filters" )
require( "triggers" )
require( "components/cavern/cavern_encounters_table" )
require( "components/cavern/cavern_room" )
require( "components/cavern/cavern_hud_roshan" )
require( "components/cavern/cavern_roshan" ) 
require( "components/cavern/tables/treasure_chest_rewards" )
require( "components/cavern/voice_lines" )

LinkLuaModifier( "modifier_antechamber_start",			"components/cavern/modifiers/modifier_antechamber_start",    		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_attack_speed_bonus",			"components/cavern/modifiers/modifier_attack_speed_bonus",   		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_blocked_gate", 				"components/cavern/modifiers/modifier_blocked_gate", 				LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_breakable_container", 		"components/cavern/modifiers/modifier_breakable_container", 		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_death_penalty", 				"components/cavern/modifiers/modifier_death_penalty", 			LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_disable_autoattack", 		"components/cavern/modifiers/modifier_disable_autoattack", 		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_force_draw_minimap", 		"components/cavern/modifiers/modifier_force_draw_minimap", 		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_generic_spawner", 			"components/cavern/modifiers/modifier_generic_spawner", 			LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_player_light",				"components/cavern/modifiers/modifier_player_light",				LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_room_destruction",			"components/cavern/modifiers/modifier_room_destruction",    		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_treasure_chest", 			"components/cavern/modifiers/modifier_treasure_chest", 			LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_treasure_chest_anim", 		"components/cavern/modifiers/modifier_treasure_chest_anim", 		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_destructible_gate", 			"components/cavern/modifiers/modifier_destructible_gate", 		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_destructible_gate_anim",		"components/cavern/modifiers/modifier_destructible_gate_anim",	LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lycan_invuln",				"components/cavern/modifiers/modifier_lycan_invuln",				LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_creature_lich_statue", 		"components/cavern/modifiers/modifier_creature_lich_statue", 		LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_provides_fow_position", 		"components/cavern/modifiers/modifier_provides_fow_position", 	LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_not_on_minimap", 			"components/cavern/modifiers/modifier_not_on_minimap", 			LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_troll_camp", 				"components/cavern/modifiers/modifier_troll_camp", 				LUA_MODIFIER_MOTION_NONE )
