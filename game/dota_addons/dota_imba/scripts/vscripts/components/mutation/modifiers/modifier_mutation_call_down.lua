LinkLuaModifier("modifier_thinker_call_down", "components/mutation/modifiers/modifier_mutation_call_down.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_thinker_call_down_second", "components/mutation/modifiers/modifier_mutation_call_down.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_call_down_slow", "components/mutation/modifiers/modifier_mutation_call_down.lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_mutation_call_down:OnIntervalThink()
    if IsServer() then
        ...
        for i = 0, self.num_call_downs do 
            local pos = Vector(0, 0, 0) + RandomVector(self.MAP_SIZE)
