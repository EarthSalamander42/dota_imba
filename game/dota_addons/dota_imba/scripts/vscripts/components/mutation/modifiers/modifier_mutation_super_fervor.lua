...
LinkLuaModifier("modifier_mutation_super_fervor_strong_buff", "components/mutation/modifiers/modifier_mutation_super_fervor.lua", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier("modifier_mutation_super_fervor_weak_buff", "components/mutation/modifiers/modifier_mutation_super_fervor.lua", LUA_MODIFIER_MOTION_NONE )
