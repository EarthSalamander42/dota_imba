...
LinkLuaModifier("modifier_item_imba_cyclone", "items/item_eul_scepter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_cyclone_active", "items/item_eul_scepter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_cyclone_active_debuff", "items/item_eul_scepter", LUA_MODIFIER_MOTION_NONE)
