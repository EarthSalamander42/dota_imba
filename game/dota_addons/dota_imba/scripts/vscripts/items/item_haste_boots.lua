...
LinkLuaModifier("modifier_imba_haste_boots", "items/item_haste_boots", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_haste_boots_buff", "items/item_haste_boots", LUA_MODIFIER_MOTION_NONE)
