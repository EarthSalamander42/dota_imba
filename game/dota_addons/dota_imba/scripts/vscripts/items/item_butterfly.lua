...
LinkLuaModifier("modifier_item_imba_butterfly", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_butterfly_unique", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_butterfly_flutter", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_butterfly_wind_song_stacks", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_butterfly_wind_song_active", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_butterfly_wind_song_slow", "items/item_butterfly", LUA_MODIFIER_MOTION_NONE)
