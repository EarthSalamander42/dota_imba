...
LinkLuaModifier("modifier_item_imba_silver_edge_passive", "items/item_silver_edge.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_silver_edge_invis", "items/item_silver_edge.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_silver_edge_invis_flying_disabled", "items/item_silver_edge.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_silver_edge_invis_panic_debuff", "items/item_silver_edge.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_silver_edge_invis_break_debuff", "items/item_silver_edge.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_silver_edge_invis_attack_cleave_particle", "items/item_silver_edge.lua", LUA_MODIFIER_MOTION_NONE)
