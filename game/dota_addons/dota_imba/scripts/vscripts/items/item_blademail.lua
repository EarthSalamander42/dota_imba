...
LinkLuaModifier("modifier_imba_blade_mail", "items/item_blademail", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_blade_mail_active", "items/item_blademail", LUA_MODIFIER_MOTION_NONE)
