...
LinkLuaModifier("modifier_item_imba_moon_shard", "items/item_moon_shard", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_imba_moon_shard_active", "items/item_moon_shard", LUA_MODIFIER_MOTION_NONE)
