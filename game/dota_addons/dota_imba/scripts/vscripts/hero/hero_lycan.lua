...
function imba_summoned_wolf_wicked_crunch:OnUpgrade()
	 local caster = self:GetCaster()
	 local ability = self	 
	 local crunch_buff = "modifier_imba_summoned_wolf_wicked_crunch"
	 
	 if not caster:HasModifier(crunch_buff) then
		caster:AddNewModifier(caster, ability, crunch_buff, {})
	 end
end
