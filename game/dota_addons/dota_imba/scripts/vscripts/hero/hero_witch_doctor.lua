witch_doctor_paralyzing_cask_imba = class({})

function witch_doctor_paralyzing_cask_imba:OnSpellStart()
...
function witch_doctor_paralyzing_cask_imba:OnProjectileHit(target, vLocation)
...
witch_doctor_voodoo_restoration_imba = class({})

function witch_doctor_voodoo_restoration_imba:GetCastRange()
	return self:GetSpecialValueFor("radius")
end

LinkLuaModifier("witch_doctor_voodoo_restoration_imba_handler", "hero/hero_witch_doctor", LUA_MODIFIER_MOTION_NONE)
function witch_doctor_voodoo_restoration_imba:OnToggle()
	if self:GetToggleState() then
		...
		self:GetCaster():AddNewModifier(self:GetCaster(), self, "witch_doctor_voodoo_restoration_imba_handler", {})
	else
		...
		self:GetCaster():RemoveModifierByName("witch_doctor_voodoo_restoration_imba_handler")
	end
end

witch_doctor_voodoo_restoration_imba_handler = class({})

function witch_doctor_voodoo_restoration_imba_handler:OnCreated()
...
function witch_doctor_voodoo_restoration_imba_handler:OnDestroy()
	if IsServer() then
...
function witch_doctor_voodoo_restoration_imba_handler:OnIntervalThink()
...
function witch_doctor_voodoo_restoration_imba_handler:IsAura()
	return true
end

function witch_doctor_voodoo_restoration_imba_handler:IsAuraActiveOnDeath()
	return false
end

function witch_doctor_voodoo_restoration_imba_handler:GetAuraRadius()
	return self.radius
end

function witch_doctor_voodoo_restoration_imba_handler:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_FRIENDLY
end

function witch_doctor_voodoo_restoration_imba_handler:GetAuraSearchType()
	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end

function witch_doctor_voodoo_restoration_imba_handler:GetModifierAura()
	return "witch_doctor_voodoo_restoration_imba_heal"
end

function witch_doctor_voodoo_restoration_imba_handler:IsHidden()
	return true
end

LinkLuaModifier("witch_doctor_voodoo_restoration_imba_heal", "hero/hero_witch_doctor", LUA_MODIFIER_MOTION_NONE)
witch_doctor_voodoo_restoration_imba_heal = class({})

function witch_doctor_voodoo_restoration_imba_heal:OnCreated()
	self.interval = self:GetAbility():GetSpecialValueFor("heal_interval")
	if IsServer() then
		self:StartIntervalThink( self.interval )
...
function witch_doctor_voodoo_restoration_imba_heal:OnRefresh()
	if IsServer() then
		self.heal = (self:GetAbility():GetSpecialValueFor("heal") + self:GetCaster():GetIntellect()*self:GetAbility():GetSpecialValueFor("int_to_heal")/100 ) * self.interval
	end
	self:SetDuration(self.stickTime, false)
...
function witch_doctor_voodoo_restoration_imba_heal:IsBuff()
	return true
end


function witch_doctor_voodoo_restoration_imba_heal:OnIntervalThink()
...
witch_doctor_maledict_imba = class({})

function witch_doctor_maledict_imba:OnSpellStart()
...
function witch_doctor_maledict_imba:GetAOERadius()
	return self:GetSpecialValueFor("radius")
end
...
witch_doctor_death_ward_imba = class({})

function witch_doctor_death_ward_imba:OnSpellStart()
	if IsServer() then
		local caster = self:GetCaster()
		local vPosition = self:GetCursorPosition()
		self.wardDamage = self:GetSpecialValueFor("damage") + caster:GetIntellect()*self:GetSpecialValueFor("int_to_damage")/100
		self.death_ward = CreateUnitByName("witch_doctor_death_ward_imba", vPosition, true, caster, nil, caster:GetTeam())
...
function witch_doctor_death_ward_imba:OnChannelFinish()
	if IsServer() then
...
function witch_doctor_death_ward_imba:OnProjectileHit_ExtraData(target, vLocation, extraData)
...
function witch_doctor_death_ward_imba:CreateBounceAttack(originalTarget, extraData)
    local caster = self:GetCaster()
