...
LinkLuaModifier("modifier_imba_tower_protective_instinct", "hero/tower_abilities.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_tower_permabash_stun", "hero/tower_abilities", LUA_MODIFIER_MOTION_NONE)
...
modifier_imba_tower_permabash_stun = class({})
