local statInfo = LoadKeyValues('scripts/vscripts/components/statcollection/settings.kv')
if not statInfo then
    print("Stat Collection: Critical Error, no settings.kv file found")
    return
end

require("components/statcollection/schema")
require('components/statcollection/lib/statcollection')
require('components/statcollection/staging')
require('components/statcollection/lib/utilities')
