...
--	   AltiV, March 31st, 2020
    ...
    -- "modifier_imba_treant_bonus",
    -- "modifier_imba_treant_eyes_in_the_forest",
    -- "modifier_imba_treant_large_bonus",
	
    -- "modifier_imba_treant_natures_guise_near_tree_display",
    -- "modifier_imba_treant_natures_guise_root",
...
function modifier_imba_treant_natures_grasp_creation_thinker:GetAuraSearchFlags()			return DOTA_UNIT_TARGET_FLAG_NONE end
function modifier_imba_treant_natures_grasp_creation_thinker:GetAuraSearchTeam()			return DOTA_UNIT_TARGET_TEAM_ENEMY end
function modifier_imba_treant_natures_grasp_creation_thinker:GetAuraSearchType()			return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC end
...
function modifier_imba_treant_leech_seed:OnIntervalThink()
	...
	self.enemy_heroes = FindUnitsInRadius(self:GetCaster():GetTeamNumber(), self:GetParent():GetAbsOrigin(), nil, self.radius, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_NONE, FIND_ANY_ORDER, false)
...
function modifier_imba_treant_leech_seed_slow:OnCreated(keys)
	...
	self.movement_slow	= keys.movement_slow * (-1)
