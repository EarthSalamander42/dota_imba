...
LinkLuaModifier( "modifier_item_imba_sange_maim", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Maim debuff
LinkLuaModifier( "modifier_item_imba_sange_disarm", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Disarm debuff
...
LinkLuaModifier( "modifier_item_imba_heavens_halberd_disarm_cooldown", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )	-- Passive disarm cooldown counter
...
LinkLuaModifier( "modifier_item_imba_yasha_stacks", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Stacking attack speed
LinkLuaModifier( "modifier_item_imba_yasha_proc", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Move speed proc
...
LinkLuaModifier( "modifier_item_imba_sange_yasha_maim", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )			-- Maim debuff
LinkLuaModifier( "modifier_item_imba_sange_yasha_disarm", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Disarm debuff
LinkLuaModifier( "modifier_item_imba_sange_yasha_stacks", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Stacking attack speed
LinkLuaModifier( "modifier_item_imba_sange_yasha_proc", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )			-- Move speed proc
...
LinkLuaModifier( "modifier_item_imba_sange_kaya", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )				-- Owner's bonus attributes, stackable
LinkLuaModifier( "modifier_item_imba_sange_kaya_stacks", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Maim/amp debuff
LinkLuaModifier( "modifier_item_imba_sange_kaya_proc", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )			-- Disarm/silence debuff
...
LinkLuaModifier( "modifier_item_imba_kaya_yasha", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )				-- Owner's bonus attributes, stackable
LinkLuaModifier( "modifier_item_imba_kaya_yasha_amp", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )			-- Amp debuff
LinkLuaModifier( "modifier_item_imba_kaya_yasha_silence", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Silence debuff
LinkLuaModifier( "modifier_item_imba_kaya_yasha_stacks", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )		-- Stacking attack speed
LinkLuaModifier( "modifier_item_imba_kaya_yasha_proc", "components/items/item_swords.lua", LUA_MODIFIER_MOTION_NONE )			-- Move speed proc
