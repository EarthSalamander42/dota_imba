...
LinkLuaModifier( "modifier_ice_boss_flying_shatter_blast_thinker", "components/siltbreaker/modifiers/modifier_ice_boss_flying_shatter_blast_thinker", LUA_MODIFIER_MOTION_NONE )
