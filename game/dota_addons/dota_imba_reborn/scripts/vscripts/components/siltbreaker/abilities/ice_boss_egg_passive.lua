...
LinkLuaModifier( "modifier_ice_boss_egg_passive", "components/siltbreaker/modifiers/modifier_ice_boss_egg_passive", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ice_boss_egg_curse_marker", "components/siltbreaker/modifiers/modifier_ice_boss_egg_curse_marker", LUA_MODIFIER_MOTION_NONE )
