...
LinkLuaModifier( "modifier_werewolf_howl_aura", "components/siltbreaker/modifiers/modifier_werewolf_howl_aura", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_werewolf_howl_aura_effect", "components/siltbreaker/modifiers/modifier_werewolf_howl_aura_effect", LUA_MODIFIER_MOTION_NONE )
