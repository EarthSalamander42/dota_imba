...
LinkLuaModifier( "modifier_sand_king_boss_burrowstrike", "components/siltbreaker/modifiers/modifier_sand_king_boss_burrowstrike", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_sand_king_boss_burrowstrike_end", "components/siltbreaker/modifiers/modifier_sand_king_boss_burrowstrike_end", LUA_MODIFIER_MOTION_HORIZONTAL )
--------------------------------------------------------------------------------
