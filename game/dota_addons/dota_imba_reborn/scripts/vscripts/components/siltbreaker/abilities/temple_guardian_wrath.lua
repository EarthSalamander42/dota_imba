...
LinkLuaModifier( "modifier_temple_guardian_wrath_thinker", "components/siltbreaker/modifiers/modifier_temple_guardian_wrath_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_temple_guardian_immunity", "components/siltbreaker/modifiers/modifier_temple_guardian_immunity", LUA_MODIFIER_MOTION_NONE )
