...
LinkLuaModifier( "modifier_spike_trap", "components/siltbreaker/modifiers/modifier_spike_trap", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_spike_trap_thinker", "components/siltbreaker/modifiers/modifier_spike_trap_thinker", LUA_MODIFIER_MOTION_NONE )
