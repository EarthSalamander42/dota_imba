storegga_grab = class({})
LinkLuaModifier( "modifier_storegga_grab", "components/siltbreaker/modifiers/modifier_storegga_grab", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_storegga_grabbed_buff", "components/siltbreaker/modifiers/modifier_storegga_grabbed_buff", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_storegga_grabbed_debuff", "components/siltbreaker/modifiers/modifier_storegga_grabbed_debuff", LUA_MODIFIER_MOTION_BOTH )
