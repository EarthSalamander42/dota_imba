...
LinkLuaModifier( "modifier_sand_king_boss_directional_move", "components/siltbreaker/modifiers/modifier_sand_king_boss_directional_move", LUA_MODIFIER_MOTION_HORIZONTAL )
