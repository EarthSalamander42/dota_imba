...
LinkLuaModifier( "modifier_siltbreaker_mind_control", "components/siltbreaker/modifiers/modifier_siltbreaker_mind_control", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_siltbreaker_mind_control_marked", "components/siltbreaker/modifiers/modifier_siltbreaker_mind_control_marked", LUA_MODIFIER_MOTION_NONE )
