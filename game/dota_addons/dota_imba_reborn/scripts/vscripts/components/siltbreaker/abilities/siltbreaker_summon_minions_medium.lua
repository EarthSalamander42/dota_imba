...
LinkLuaModifier( "modifier_siltbreaker_summon_minions_medium", "components/siltbreaker/modifiers/modifier_siltbreaker_summon_minions_medium", LUA_MODIFIER_MOTION_NONE )
