...
LinkLuaModifier( "modifier_undead_tusk_mage_tombstone", "components/siltbreaker/modifiers/modifier_undead_tusk_mage_tombstone", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_undead_tusk_mage_passive", "components/siltbreaker/modifiers/modifier_undead_tusk_mage_passive", LUA_MODIFIER_MOTION_NONE )
