...
LinkLuaModifier( "modifier_ogre_seer_area_ignite_thinker", "components/siltbreaker/modifiers/modifier_ogre_seer_area_ignite_thinker", LUA_MODIFIER_MOTION_NONE )
