...
LinkLuaModifier( "modifier_ogre_magi_channelled_bloodlust", "components/siltbreaker/modifiers/modifier_ogre_magi_channelled_bloodlust", LUA_MODIFIER_MOTION_NONE )
