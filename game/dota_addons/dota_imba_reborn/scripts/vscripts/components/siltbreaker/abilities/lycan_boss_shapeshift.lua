...
LinkLuaModifier( "modifier_lycan_boss_shapeshift_transform", "components/siltbreaker/modifiers/modifier_lycan_boss_shapeshift_transform", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lycan_boss_shapeshift", "components/siltbreaker/modifiers/modifier_lycan_boss_shapeshift", LUA_MODIFIER_MOTION_NONE )
