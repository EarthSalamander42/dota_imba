...
LinkLuaModifier( "modifier_large_frostbitten_icicle", "components/siltbreaker/modifiers/modifier_large_frostbitten_icicle", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_large_frostbitten_icicle_thinker", "components/siltbreaker/modifiers/modifier_large_frostbitten_icicle_thinker", LUA_MODIFIER_MOTION_NONE )
