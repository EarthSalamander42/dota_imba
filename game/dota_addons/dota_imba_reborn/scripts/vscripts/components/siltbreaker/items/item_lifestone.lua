...
LinkLuaModifier( "modifier_item_lifestone", "components/siltbreaker/modifiers/modifier_item_lifestone", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_lifestone_pact", "components/siltbreaker/modifiers/modifier_item_lifestone_pact", LUA_MODIFIER_MOTION_NONE )
