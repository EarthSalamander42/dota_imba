...
LinkLuaModifier( "modifier_item_ogre_seal_totem", "components/siltbreaker/modifiers/modifier_item_ogre_seal_totem", LUA_MODIFIER_MOTION_BOTH )
LinkLuaModifier( "modifier_ogreseal_flop", "components/siltbreaker/modifiers/modifier_ogreseal_flop", LUA_MODIFIER_MOTION_BOTH )
