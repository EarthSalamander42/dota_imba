...
LinkLuaModifier( "modifier_item_glimmerdark_shield", "components/siltbreaker/modifiers/modifier_item_glimmerdark_shield", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_glimmerdark_shield_prism", "components/siltbreaker/modifiers/modifier_item_glimmerdark_shield_prism", LUA_MODIFIER_MOTION_NONE )
