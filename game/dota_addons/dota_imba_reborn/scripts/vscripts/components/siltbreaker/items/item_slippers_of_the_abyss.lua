...
LinkLuaModifier( "modifier_item_slippers_of_the_abyss", "components/siltbreaker/modifiers/modifier_item_slippers_of_the_abyss", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_slippers_of_the_abyss_sprint", "components/siltbreaker/modifiers/modifier_item_slippers_of_the_abyss_sprint", LUA_MODIFIER_MOTION_NONE )
