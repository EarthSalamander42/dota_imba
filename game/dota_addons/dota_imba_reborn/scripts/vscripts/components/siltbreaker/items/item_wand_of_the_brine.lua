...
LinkLuaModifier( "modifier_item_wand_of_the_brine", "components/siltbreaker/modifiers/modifier_item_wand_of_the_brine", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_wand_of_the_brine_bubble", "components/siltbreaker/modifiers/modifier_item_wand_of_the_brine_bubble", LUA_MODIFIER_MOTION_NONE )
