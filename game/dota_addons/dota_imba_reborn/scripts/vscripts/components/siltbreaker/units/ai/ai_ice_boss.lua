...
--[[ components/siltbreaker/units/ai/ai_ice_boss.lua ]]
...
--------------------------------------------------------------------------------
LinkLuaModifier( "modifier_ice_boss_passive", "components/siltbreaker/modifiers/modifier_ice_boss_passive", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ice_boss_trapping_shards", "components/siltbreaker/modifiers/modifier_ice_boss_trapping_shards", LUA_MODIFIER_MOTION_NONE )
