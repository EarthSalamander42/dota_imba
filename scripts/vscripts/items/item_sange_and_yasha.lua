...
function YashaIllusion( keys )
	...
	-- Parameters
	local illusion_duration = ability:GetLevelSpecialValueFor("passive_duration", ability_level)
	...
	ability:ApplyDataDrivenModifier(caster, illusion, "modifier_item_imba_sange_and_yasha_illusion_effect", {})
