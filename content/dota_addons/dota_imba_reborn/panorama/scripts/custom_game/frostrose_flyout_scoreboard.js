...
(function () {
	...
	if (ScoreboardUpdater_InitializeScoreboard === null) {
		$.Msg("WARNING: This file requires frostrose_shared_scoreboard_updater.js to be included.");
	}

	var scoreboardConfig = {
		"teamXmlName": "file://{resources}/layout/custom_game/frostrose_flyout_scoreboard_team.xml",
		"playerXmlName": "file://{resources}/layout/custom_game/frostrose_flyout_scoreboard_player.xml",
	};
